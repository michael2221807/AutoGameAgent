<template>
  <nav v-if="isMobile" class="mobile-nav" role="navigation" :aria-label="$t('layout.mobile.ariaNav')">
    <router-link
    ...
    <button
      ...
      :aria-label="$t('layout.mobile.ariaCharacterStatus')"
      @click="toggleRight"
    >
    ...
    <button
      ...
      :aria-label="$t('layout.mobile.ariaMorePanels')"
      @click="toggleLeft"
    >
      <span class="mobile-nav__icon">
...
const routeItems = computed(() => [
  {
    route: '/game',
    label: t('layout.mobile.item.mainPanel'),
  ...
  },
  {
    ...
    label: t('layout.mobile.item.character'),
  ...
  },
  {
    ...
    label: t('layout.mobile.item.relationships'),
